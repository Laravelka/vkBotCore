...
namespace Engine\Libs\VkApi;

use CURLFile;
use InvalidArgumentException;
use OutOfRangeException;
use Engine\Libs\VkApi\Enums\Language;
use Engine\Libs\VkApi\Exceptions\RequestException;
use Engine\Libs\VkApi\Exceptions\ResponseException;
...
class Client
{
    ...
    public function __construct(string $access_token, string $version = '5.103', int $language = Language::RUSSIAN)
    {
